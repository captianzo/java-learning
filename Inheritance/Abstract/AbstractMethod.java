// Abstract methods are declared without any implementation (no body)
...
public class AbstractMethod {
	public static void main(String[] args) {
		...
		// when defining object that references the parent class and points to the child class ex- Animal animal = new Dog(); 
